...
public class ActiveMQMessageConsumerMainApp {
    ...
    private static void consumeCustomerVTCQueue() {
        ...
        // picked up.
        ActiveMQMessageConsumer queueMsgListener = new ActiveMQMessageConsumer("tcp://localhost:61616", "artemis",
                "artemis");
        queueMsgListener.setDestinationName(DataUtil.CUSTOMER_VTC_TOPIC);
